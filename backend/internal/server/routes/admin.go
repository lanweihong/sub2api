...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/cache-stats", h.Admin.Dashboard.GetCacheStats)
...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.POST("/batch/preview", h.Admin.User.PreviewBatch)
		users.POST("/batch", h.Admin.User.CreateBatch)
		...
		users.GET("/:id/available-groups", h.Admin.User.GetUserAvailableGroups)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// 报文审计日志配置
		adminSettings.GET("/payload-logging", h.Admin.Setting.GetPayloadLoggingSettings)
		adminSettings.PUT("/payload-logging", h.Admin.Setting.UpdatePayloadLoggingSettings)
		// Web Search 模拟配置
