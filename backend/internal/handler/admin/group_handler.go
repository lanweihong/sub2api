...
type CreateGroupRequest struct {
	...
	Platform         string             `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity sora anthropic-compatible anthropic-zhipu anthropic-kimi anthropic-minimax anthropic-qwen anthropic-mimo"`
