...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ChannelMonitorRequestTemplate, c.Department, c.ErrorPassthroughRule,
		...
		c.UsageCleanupTask, c.UsageLog, c.UsageLogPayload, c.User,
...
type (
	hooks struct {
		...
		ChannelMonitorHistory, ChannelMonitorRequestTemplate, Department,
