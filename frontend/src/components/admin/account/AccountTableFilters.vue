...
const pOpts = computed(() => [
  ...
  { value: 'anthropic-compatible', label: t('admin.accounts.platforms.anthropic-compatible') },
  { value: 'anthropic-zhipu', label: t('admin.accounts.platforms.anthropic-zhipu') },
  { value: 'anthropic-kimi', label: t('admin.accounts.platforms.anthropic-kimi') },
  { value: 'anthropic-minimax', label: t('admin.accounts.platforms.anthropic-minimax') },
  { value: 'anthropic-qwen', label: t('admin.accounts.platforms.anthropic-qwen') },
  { value: 'anthropic-mimo', label: t('admin.accounts.platforms.anthropic-mimo') }
])
