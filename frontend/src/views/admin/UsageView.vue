...
const currentToggleableColumns = computed(() => toggleableColumns.value)
const isCurrentColumnVisible = (key: string) => isColumnVisible(key)
const toggleCurrentColumn = (key: string) => toggleColumn(key)
