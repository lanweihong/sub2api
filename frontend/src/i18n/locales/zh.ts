export default {
  ...
  keys: {
    ...
    multiGroup: {
      label: '多分组绑定',
      hint: '绑定多个分组后，系统将根据请求模型自动选择对应分组（优先匹配模型规则，然后按优先级排序）',
      enable: '启用多分组',
      addGroup: '添加分组',
      priority: '优先级',
      modelPatterns: '模型匹配规则',
      modelPatternsPlaceholder: '例如 claude-*,gpt-4*（留空则按分组支持范围自动匹配）',
      removeGroup: '移除',
      noGroupSelected: '请选择分组',
      duplicateGroup: '分组已存在',
      savedSuccess: '多分组绑定保存成功',
      saveFailed: '保存多分组绑定失败',
      boundGroups: '绑定分组',
    },
    usage: '用量',
    today: '今日',
  ...
  admin: {
    ...
    users: {
      ...
      departmentFilterIncludesChildren: '含子部门',
      fuzzySearch: '模糊搜索',
      statusFilter: '状态筛选',
      allStatuses: '全部状态',
      admin: '管理员',
      ...
      batchCreate: {
        open: '批量新增',
        title: '批量新增用户',
        hint: '上传 txt 名单后将自动识别并生成用户名、邮箱和随机密码。识别结果支持逐行修改后再统一提交。',
        selectFile: '选择名单文件',
        fileFormat: 'TXT 文件，一行一个中文名称',
        previewing: '正在识别名单...',
        emptyState: '上传 txt 文件后，这里会显示可编辑的批量新增预览结果。',
        emptyFile: '名单文件为空，请至少提供一个姓名',
        previewFailed: '识别名单失败',
        success: '成功新增 {count} 个用户',
        completedTitle: '批量新增成功',
        completedDescription: '已成功新增 {count} 个用户。请立即下载账号信息，关闭弹窗后将无法再次查看初始密码。',
        createdCount: '新增数量',
        downloadIncludes: '下载内容',
        downloadCredentials: '下载账号信息',
        failed: '批量新增失败',
        fixErrors: '请先修正表格中的错误后再提交',
        totalRows: '总行数',
        validRows: '可提交',
        errorRows: '错误行',
        sourceName: '原始姓名',
        bulkBalance: '批量余额',
        bulkConcurrency: '批量并发',
        applyBalance: '应用到全部',
        applyConcurrency: '应用到全部',
        regeneratePasswords: '重置全部密码',
        submitting: '提交中...',
        validation: {
          usernameRequired: '用户名不能为空',
          ...
          balanceInvalid: '余额必须是大于等于 0 的有效数字',
          concurrencyInvalid: '并发数必须是大于等于 1 的整数',
          duplicateEmail: '当前批次中邮箱重复',
          duplicateUsername: '当前批次中用户名重复'
        }
      },
      userCreated: '用户创建成功',
      userUpdated: '用户更新成功',
    ...
    departments: {
      ...
      enterName: '请输入部门名称',
      enterCode: '请输入部门编码',
      enterCodeOptional: '部门代码（可选）',
      enterDescription: '请输入描述（选填）',
      creating: '创建中...',
      updating: '更新中...',
      deleteConfirm: "确定要删除部门 '{name}' 吗？",
      deleteForceHint: '该部门下存在子部门，需要强制删除',
      deleteChildrenFirst: '请先删除或迁移子部门',
      forceDelete: '强制删除',
      forceDeleteTitle: '强制删除部门',
      forceDeleteConfirm: "部门 '{name}' 下有用户，强制删除会将所有用户迁回默认部门。是否继续？",
      failedToLoad: '加载部门列表失败',
      failedToCreate: '创建部门失败',
      failedToUpdate: '更新部门失败',
      failedToDelete: '删除部门失败',
      createdSuccess: '部门创建成功',
      updatedSuccess: '部门更新成功',
      deletedSuccess: '部门删除成功',
      noDepartments: '暂无部门',
      columns: {
        name: '名称',
        code: '编码',
    ...
    accounts: {
      ...
      zhipuUsage: {
        ...
        toolUsage: '工具用量',
        quota: '配额',
        fiveHourToken: '5小时Token',
        weeklyToken: '7天Token',
        monthlyMcp: '月度MCP',
        fiveHourQuota: '每5小时使用额度',
        weeklyQuota: '每周使用额度',
        monthlyQuota: 'MCP每月额度',
        used: '已使用',
        resetTime: '重置时间',
        today: '当日',
        last7Days: '近7天',
        last30Days: '近30天',
        totalTokenConsumption: 'Token 消耗总量',
        totalToolCalls: '工具调用总量',
        consumption: '消耗',
        calls: '调用',
        platform: {
          zai: 'Z.ai',
      ...
      openai: {
        ...
        chatCompletionsDirectForward: 'Chat Completions 直通转发',
        chatCompletionsDirectForwardDesc:
          '开启后，/v1/chat/completions 将跳过 Responses API 转换，直接转发到上游 /v1/chat/completions，适用于仅支持 Chat Completions 的 OpenAI-compatible 上游。',
        chatCompletionsDirectForwardPassthroughHint:
          '同时开启时：自动透传仅作用于 /v1/responses，直通转发仅作用于 /v1/chat/completions；两者不会互相覆盖。',
    ...
    usage: {
      ...
      cacheStatsTitle: '缓存率分析',
      cacheStatsSubtitle: '按维度查看缓存读取率和缓存 Token 占比',
      cacheReadRate: '缓存读取率',
      cacheTokenRate: '缓存 Token 率',
      dimensionUser: '用户',
      dimensionApiKey: 'API 密钥',
      dimensionAccount: '账号',
      dimensionGroup: '分组',
      dimensionModel: '模型',
      dimensionEndpoint: '端点',
      dimensionDay: '按天',
      dimensionHour: '按小时',
      failedToLoad: '加载使用记录失败',
      billingType: '计费类型',
    ...
    settings: {
      ...
      payloadLogging: {
        title: '报文审计记录',
        description: '开启后将保存每次 API 请求的请求和响应报文，用于审计和问题排查。',
        enabled: '开启报文记录',
        maxRequestSize: '请求报文最大长度（字节）',
        maxResponseSize: '响应报文最大长度（字节）',
        retentionDays: '报文保留天数',
        retentionDaysHint: '超过天数的报文将自动清理，0 表示不自动清理',
        saved: '报文审计设置已保存',
        saveFailed: '保存报文审计设置失败',
      },
      site: {
        title: '站点设置',
        description: '自定义站点品牌',
