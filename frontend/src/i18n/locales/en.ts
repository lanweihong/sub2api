export default {
  ...
  keys: {
    ...
    multiGroup: {
      label: 'Multi-Group Binding',
      hint: 'When multiple groups are bound, the system auto-selects the matching group based on the requested model (matched by model rules first, then by priority)',
      enable: 'Enable Multi-Group',
      addGroup: 'Add Group',
      priority: 'Priority',
      modelPatterns: 'Model Patterns',
      modelPatternsPlaceholder: 'e.g. claude-*,gpt-4* (leave empty for auto-match by group scope)',
      removeGroup: 'Remove',
      noGroupSelected: 'Please select a group',
      duplicateGroup: 'Group already exists',
      savedSuccess: 'Multi-group bindings saved successfully',
      saveFailed: 'Failed to save multi-group bindings',
  ...
  admin: {
    ...
    users: {
      ...
      departmentFilterIncludesChildren: 'Includes sub-departments',
      ...
      batchCreate: {
        ...
        hint: 'Upload a txt roster to generate usernames, emails, and random passwords. You can edit each row before submitting.',
        selectFile: 'Select roster file',
        fileFormat: 'TXT file, one Chinese name per line',
        previewing: 'Previewing roster...',
        emptyState: 'Upload a txt file to preview editable batch-created users here.',
        emptyFile: 'The roster file is empty. Add at least one name.',
        previewFailed: 'Failed to preview roster',
        success: 'Created {count} users successfully',
        completedTitle: 'Batch creation successful',
        completedDescription: 'Successfully created {count} user(s). Download the account info now because the initial passwords will not be visible after you close this dialog.',
        createdCount: 'Created users',
        downloadIncludes: 'Download includes',
        downloadCredentials: 'Download account info',
        failed: 'Failed to batch create users',
        fixErrors: 'Fix the errors in the table before submitting',
        totalRows: 'Total rows',
        validRows: 'Ready',
        errorRows: 'Errors',
        sourceName: 'Original name',
        bulkBalance: 'Bulk balance',
        bulkConcurrency: 'Bulk concurrency',
        applyBalance: 'Apply to all',
        applyConcurrency: 'Apply to all',
        regeneratePasswords: 'Reset all passwords',
        submitting: 'Submitting...',
        validation: {
          usernameRequired: 'Username is required',
          ...
          balanceInvalid: 'Balance must be a valid number greater than or equal to 0',
          concurrencyInvalid: 'Concurrency must be an integer greater than or equal to 1',
          duplicateEmail: 'Email is duplicated in this batch',
          duplicateUsername: 'Username is duplicated in this batch'
        }
      },
    ...
    departments: {
      ...
      description: 'Manage organizational department structure',
      ...
      enterCodeOptional: 'Code (optional)',
      enterDescription: 'Enter description (optional)',
      creating: 'Creating...',
      updating: 'Updating...',
      deleteConfirm: "Are you sure you want to delete department '{name}'?",
      deleteForceHint: 'This department has child departments, force delete required',
      deleteChildrenFirst: 'Please delete or move child departments first',
      forceDelete: 'Force Delete',
      forceDeleteTitle: 'Force Delete Department',
      forceDeleteConfirm: "Department '{name}' has users. Force deleting will move all users to the default department. Continue?",
      failedToLoad: 'Failed to load departments',
    ...
    accounts: {
      ...
      openai: {
        ...
        chatCompletionsDirectForward: 'Chat Completions direct forward',
        chatCompletionsDirectForwardDesc:
          'When enabled, /v1/chat/completions skips Responses API conversion and forwards directly to the upstream /v1/chat/completions endpoint. Use this for OpenAI-compatible upstreams that only support Chat Completions.',
        chatCompletionsDirectForwardPassthroughHint:
          'When both are enabled, auto passthrough only applies to /v1/responses and direct forward only applies to /v1/chat/completions; they do not override each other.',
    ...
    usage: {
      ...
      cacheStatsTitle: 'Cache Rate Analysis',
      cacheStatsSubtitle: 'Analyze cache read rate and cache token share by dimension',
      cacheReadRate: 'Cache Read Rate',
      cacheTokenRate: 'Cache Token Rate',
      dimensionUser: 'User',
      dimensionApiKey: 'API Key',
      ...
      duration: 'Duration',
      createdAt: 'Created At',
      detailTitle: 'Usage Record Details',
      basicInfo: 'Basic Info',
      requestBody: 'Request Body',
      responseBody: 'Response Body',
      truncated: 'Truncated',
      noPayload: 'No payload data',
      payloadLoadError: 'Failed to load payload data',
      cleanup: {
        button: 'Cleanup',
    ...
    settings: {
      ...
      payloadLogging: {
        title: 'Payload Audit Logging',
        description: 'When enabled, request and response payloads of each API call will be saved for auditing and troubleshooting.',
        enabled: 'Enable Payload Logging',
        maxRequestSize: 'Max Request Payload Size (bytes)',
        maxResponseSize: 'Max Response Payload Size (bytes)',
        retentionDays: 'Retention Days',
        retentionDaysHint: 'Payloads older than this will be automatically cleaned up. 0 means no auto cleanup.',
        saved: 'Payload logging settings saved',
        saveFailed: 'Failed to save payload logging settings',
      },
      site: {
        title: 'Site Settings',
